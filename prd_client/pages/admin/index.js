...
import AccountSummary from "../../components/Admin/Dashboard/AccountsSummary";
  ...
  return (
    <div className="font-inter overflow-y-scroll h-screen w-full bg-[#f5f8fa]">
      ...
      <div className="py-4 px-6 h-full">
        ...
        <div className="mountedanimater mt-6 rounded-md smooth-shadow-fine flex justify-start">
          <div className="w-1/3">
            <AccountSummary className="mr-2" />
          </div>
        </div>
