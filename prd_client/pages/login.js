                ...
                <form>
                    <div className="mt-8 form-control w-full max-w-xs">
                        ...
                        <input
                            ...
                            value={email}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 max-w-xs focus:ring-4 hover:ring-4 ${!err.includes("not found") &&
                    ...
                    <div className="mt-3 form-control w-full max-w-xs relative">
                        ...
                        <input
                            ...
                            value={password}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 max-w-xs focus:ring-4 hover:ring-4 ${err.includes("Invalid") ||
