                ...
                <form>
                    <div className="mt-3 form-control w-full">
                        ...
                        <input
                            ...
                            value={email}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${!err.includes("email") &&
                    ...
                    <div className="mt-3 form-control w-full">
                        ...
                        <input
                            ...
                            value={userName}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${Validator(userName, ["isEmpty"])
                                    ? "focus:ring-fuchsia-100"
                                    : "ring-2 ring-rose-300"
                                }`}
                        />
                    ...
                    <div className="mt-3 form-control w-full">
                        ...
                        <input
                            ...
                            value={contact}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${Validator(contact, ["isEmpty"])
                                    ? "focus:ring-fuchsia-100"
                                    : "ring-2 ring-rose-300"
                                }`}
                        />
                    ...
                    <div className="mt-3 form-control w-full">
                        ...
                        <textarea
                            ...
                            value={address}
                            className={`textarea bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${Validator(address, ["isEmpty"])
                                    ? "focus:ring-fuchsia-100"
                                    : "ring-2 ring-rose-300"
                                }`}
                        />
                    ...
                    <div className="mt-3 form-control w-full relative">
                        ...
                        <input
                            ...
                            value={password}
                            className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${Validator(password, ["isEmpty", "min"], 8)
                                    ? "focus:ring-fuchsia-100"
                                    : "ring-2 ring-rose-300"
                                }`}
                        />
                    ...
                    </div>
                    {
                        userType === 1 && <div className="mt-3 form-control w-full relative">
                            ...
                            <input
                                ...
                                className={`input input-sm bg-base-200/50 w-full hover:bg-base-100 focus:ring-4 hover:ring-4 ${Validator(secret, ['equals'], 0, 0, REGISTER_ADMIN_SECRET)
                                        ? "focus:ring-fuchsia-100"
                                        : "ring-2 ring-rose-300"
                                    }`}
                            />
